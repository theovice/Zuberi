...
const PHASES = [
  ...
  },
  {
    ...
    status: "active",
    items: [
      { name: "Local version poller (RTL-034)", status: "pending", note: "Part 1 prompt ready" },
      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 20, padding: "10px 12px", background: "rgba(72,202,228,0.08)", border: "1px solid rgba(72,202,228,0.2)", borderRadius: 6 }}>
          ...
          <div style={{ fontSize: 13, color: "#ccc" }}>
            RTL-034: Local version poller — Phase 1 (indicator only). Part 1 prompt ready: Rust backend + version.json generation.
          </div>
        </div>
        ...
        <div style={{ marginTop: 8, padding: "10px 12px", background: "rgba(240,165,0,0.08)", border: "1px solid rgba(240,165,0,0.2)", borderRadius: 6 }}>
          ...
          <div style={{ fontSize: 13, color: "#ccc" }}>
            RTL-033: Hugging Face integration (research complete). RTL-002: n8n workflows (James testing). RTL-014: MISSION-AEGIS strategy. RTL-044: OpenClaw auto-discovery eval (deferred).
          </div>
        </div>

        <div style={{ textAlign: "center", marginTop: 20, fontSize: 11, color: "#444" }}>
          Updated 2026-03-07 · Session 13 · Architect 13
        </div>
      </div>
    </div>
  );
