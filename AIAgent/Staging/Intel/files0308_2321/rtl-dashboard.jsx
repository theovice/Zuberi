...
const CAPABILITIES = [
  ...
  { id: "C12", name: "Vision/OCR", status: "pending", note: "Model configured, skill needed" },
      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 2 }}>
            ...
            <span style={{ fontSize: 12, color: "#555", fontFamily: "'JetBrains Mono', monospace" }}>v0.1.2</span>
          </div>
        ...
        <div style={{ marginTop: 20, padding: "10px 12px", background: "rgba(72,202,228,0.08)", border: "1px solid rgba(72,202,228,0.2)", borderRadius: 6 }}>
          ...
          <div style={{ fontSize: 13, color: "#ccc" }}>
            RTL-047 Phase 2: ToolApprovalCard UI for pending approvals. RTL-007: Express 5 wildcard fix.
          </div>
        </div>

        <div style={{ textAlign: "center", marginTop: 20, fontSize: 11, color: "#444" }}>
          Updated 2026-03-08 · Session 13 · Architect 13
        </div>
      </div>
    </div>
  );
